...
@implementation FacebookMenuTVC
...
- (void)viewDidLoad
{
	...
	// Load the data.
    //NSString *dataPath = [[NSBundle mainBundle] pathForResource:@"facebook-menu" ofType:@"plist"];
    self.data = [NSArray arrayWithObjects:@"Facebook Login", @"Facebook Logout", nil];
